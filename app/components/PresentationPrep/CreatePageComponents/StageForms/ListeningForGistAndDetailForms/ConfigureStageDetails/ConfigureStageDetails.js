...
const styles = {
  ...
  sub: { fontSize: "15px", color: "#6f6b63", maxWidth: "56ch", lineHeight: 1.5, margin: 0 },
  layout: { display: "flex", gap: "32px", alignItems: "flex-start" },
  stack: { flex: 1, minWidth: 0, display: "flex", flexDirection: "column", gap: "18px" },
  anchor: { scrollMarginTop: "24px" },
  empty: { padding: "32px", textAlign: "center", color: "#6f6b63", border: "1.5px dashed #e6e3db", borderRadius: "12px", fontSize: "15px" },
};
